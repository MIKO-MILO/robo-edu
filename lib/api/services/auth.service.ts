...
export const authService = {
   ...
   */
  async login(body: LoginRequestBody): Promise<ApiResponse<LoginResponseData>> {
    return http.post<ApiResponse<LoginResponseData>>("/auth/login", body);
  },
   ...
   */
  async register(body: RegisterRequestBody): Promise<ApiResponse<User>> {
    return http.post<ApiResponse<User>>("/auth/register", body);
  },
  ...
  async getMe(): Promise<UserMeResponse> {
    return http.get<UserMeResponse>("/auth/me");
  },
};
